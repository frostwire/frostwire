...
/**
 * Torrentz2 V2 Search Pattern Test
 * Performs real searches against torrentz2.nz to validate pattern matching
 *
 * gradle test --tests "com.frostwire.tests.Torrentz2SearchPatternTest.torrentz2SearchTest"
 */
public final class Torrentz2SearchPatternTest {
    ...
    public void torrentz2SearchTest() {
        ...
        try {
            LOG.info("Torrentz2SearchPatternTest: Starting search for '" + searchTerm + "'");
            performer.perform();
        } catch (Throwable t) {
            t.printStackTrace();
        ...
        LOG.info("Torrentz2SearchPatternTest: PASSED");
    }
