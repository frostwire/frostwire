...
class Bip39MnemonicTest {
    ...
    void knownVectorAllZeros() {
        byte[] entropy = hexToBytes(
                "00000000000000000000000000000000" +
                "00000000000000000000000000000000");
        String expected = "abandon abandon abandon abandon abandon abandon abandon abandon " +
    ...
    void knownVectorAllOnes() {
        byte[] entropy = hexToBytes(
                ...
                "ffffffffffffffffffffffffffffffff");
        String expected = "zoo zoo zoo zoo zoo zoo zoo zoo " +
    ...
    void knownVector7f() {
        byte[] entropy = hexToBytes(
                ...
                "7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f");
        String expected = "legal winner thank year wave sausage worth useful " +
    ...
    void knownVector80() {
        byte[] entropy = hexToBytes(
                ...
                "80808080808080808080808080808080");
        String expected = "letter advice cage absurd amount doctor acoustic avoid " +
    ...
    void roundTripRandom32Bytes() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            byte[] recovered = Bip39Mnemonic.mnemonicToEntropy(mnemonic);
            assertArrayEquals(entropy, recovered,
                    "round-trip failed for entropy #" + i);
        }
    }
    ...
    void nullMnemonicThrows() {
        assertThrows(IllegalArgumentException.class,
                () -> Bip39Mnemonic.validate(null));
    }

    @Test
    void invalidEntropyLengthThrows() {
        assertThrows(IllegalArgumentException.class,
                () -> Bip39Mnemonic.entropyToMnemonic(new byte[17]));
    }
