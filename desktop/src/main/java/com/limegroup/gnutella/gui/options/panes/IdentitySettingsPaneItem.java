...
public final class IdentitySettingsPaneItem extends AbstractPaneItem {
    ...
    private JPanel buildActionsPanel() {
        ...
        panel.add(SHOW_SEED_BUTTON);
        panel.add(ENTER_SEED_BUTTON);
    ...
    private void refreshIdentityInfo() {
        ...
        DIFFICULTY_LABEL.setText(difficulty + " bits" +
    ...
    private void showSeedPhrase() {
        ...
        try {
            ...
            JLabel warning = new JLabel("<html><b>" + I18n.tr("WARNING:") + "</b> " +
                    I18n.tr("Anyone with this phrase can impersonate you and access your karma reputation. " +
    ...
    private void restoreFromSeedPhrase() {
        int confirm = JOptionPane.showConfirmDialog(
                GUIMediator.getAppFrame(),
                "<html>" + I18n.tr("Restoring from a seed phrase will <b>permanently replace</b> your current identity, " +
                        ...
                        "FrostWire will need to restart after restoring.") + "</html>",
        ...
        String mnemonic = JOptionPane.showInputDialog(
                GUIMediator.getAppFrame(),
        ...
        try {
            ...
            File backup = new File(homeDir, RelayConstants.IDENTITY_FILE + ".bak");
            if (identityFile.exists()) {
                Files.copy(identityFile.toPath(), backup.toPath(),
            ...
            JOptionPane.showMessageDialog(
                    GUIMediator.getAppFrame(),
                    I18n.tr("Identity restored successfully. FrostWire will now restart to apply the new identity."),
    ...
    private void exportIdentityFile() {
        ...
        File selected = FileChooserHandler.getSaveAsFile(
                "Export Identity",
    ...
    private void importIdentityFile() {
        int confirm = JOptionPane.showConfirmDialog(
                GUIMediator.getAppFrame(),
                "<html>" + I18n.tr("Importing an identity file will <b>permanently replace</b> your current identity. " +
                        "This cannot be undone. FrostWire will need to restart after importing.") + "</html>",
                I18n.tr("Confirm Identity Replacement"),
                JOptionPane.YES_NO_OPTION,
                JOptionPane.WARNING_MESSAGE);
        if (confirm != JOptionPane.YES_OPTION) {
        ...
        File selected = FileChooserHandler.getInputFile(
                GUIMediator.getAppFrame(),
                new FileNameExtensionFilter(I18n.tr("FrostWire Identity File"), "dat"));
        if (selected == null) {
            return;
        ...
        try {
            ...
            Files.copy(selected.toPath(), identityFile.toPath(),
                    StandardCopyOption.REPLACE_EXISTING);
