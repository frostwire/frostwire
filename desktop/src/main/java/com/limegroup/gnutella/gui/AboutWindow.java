...
final class AboutWindow {
  ...
  AboutWindow() {
    ...
    if (!OSUtils.isMacOSX()) DIALOG.setModal(true);
    ...
    JLabel telluride = new JLabel("Telluride");
    telluride.setHorizontalAlignment(SwingConstants.CENTER);
    loadTellurideBuild(telluride);
    ...
    JLabel EULA_LABEL =
        new URLLabel("https://www.frostwire.com/eula", I18n.tr("End User License Agreement"));
    JLabel PRIVACY_POLICY_LABEL =
        new URLLabel("https://www.frostwire.com/privacy", I18n.tr("Privacy Policy"));
    ...
    pane.add(telluride, "align center, wrap");
  ...
  private static void loadTellurideBuild(JLabel telluride) {
    ThreadExecutor.startThread(
        () -> {
          ...
          SwingUtilities.invokeLater(() -> telluride.setText("Telluride build " + build));
        },
        "telluride-build");
  }

  private void appendListOfNames(String commaSepNames, StringBuilder sb) {
    for (String name : commaSepNames.split(",")) sb.append("<li>").append(name).append("</li>");
  }
  ...
  private ScrollingTextPane createScrollingPane() {
    ...
    sb.append("<h1>Powered by</h1>")
        .append("<ul>")
        .append("<li><a href='https://jlibtorrent.org'>JLibTorrent</a> ")
        .append(LibTorrent.jlibtorrentVersion())
        .append("</li>")
        .append("<li><a href='https://www.boost.org/'>Boost</a> ")
        .append(LibTorrent.boostVersion())
        .append("</li>")
        .append("<li><a href='https://www.openssl.org/'>OpenSSL</a> ")
        .append(LibTorrent.opensslVersion());
    //  introduction
    sb.append("<h1>").append(I18n.tr("FrostWire Logo Designer")).append("</h1>");
    sb.append(
        "<ul><li>Luis Ramirez (Venezuela - <a href='http://www.elblogo.com'>ElBlogo.com</a>)</li></ul>");
    sb.append("<h1>").append(I18n.tr("FrostWire Graphics Designers/Photographers")).append("</h1>");
    sb.append("<ul>");
    sb.append(
        "<li>Kirill Grouchnikov - Substance library <a href='http://www.pushing-pixels.org/'>Pushing-Pixels.org</a></li>");
    sb.append(
        "<li>Arianys Wilson - Splash 4.18 (New York - <a href='http://www.arianyswilson.com/'>Arianys Wilson Photography</a>)</li>");
    sb.append(
        "<li>Scott Kellum - Splash 4.17 (New York - <a href='http://www.scottkellum.net'>ScottKellum.net</a>)</li>");
    sb.append("<li>Shelby Allen - Splash 4.13 (New Zealand)</li>");
    sb.append(
        "<li>Cecko Hanssen - <a href='https://www.flickr.com/photos/cecko/95013472/'>Frozen Brothers</a> CC Photograph for 4.17 Splash (Tilburg, Netherlands)</li>");
    sb.append(
        "<li>Marcelina Knitter - <a href='https://twitter.com/#!/marcelinkaaa'>@Marcelinkaaa</a></li>");
    sb.append("</ul>");
    sb.append("<h1>").append(I18n.tr("Thanks to Former FrostWire Developers")).append("</h1>");
    sb.append(
        "<li>Alden Torres (<a href='https://github.com/frostwire/frostwire/commits?author=aldenml'>@aldenml</a>)</li>");
    sb.append(
        "<li>Marcelina Knitter (<a href='https://github.com/frostwire/frostwire/commits?author=marcelinkaaa'>@marcelinkaaa</a>)</li>");
    sb.append(
        "<li>Erika Acosta (<a href='https://github.com/frostwire/frostwire/commits?author=muckachina'>@muckachina</a>)</li>");
    sb.append(
        "<li>Alejandro Martinez (<a href='https://github.com/frostwire/frostwire/commits?author=alejandroarturom'>@alejandroarturom</a>)</li>");
    sb.append("<li>Gregorio Roper (Germany)</li>");
    sb.append(
        "<li>Fernando Toussaint '<strong>FTA</strong>' - <a href='http://www.cybercultura.com'>Web</a></li>");
    sb.append("<li>Erich Pleny</li>");
    sb.append("<br><br>");
    sb.append("<h1>").append(I18n.tr("Thanks to the FrostWire Chat Community!")).append("</h1>");
    sb.append(
        I18n.tr(
            "Thanks to everybody that has helped us everyday in the forums and chatrooms, "
    ...
    sb.append(
        I18n.tr(
            "<br><br>In Special we give thanks to the Chatroom Operators and Forum Moderators"));
    sb.append("<ul>");
    sb.append("<h1>").append(I18n.tr("FrostWire Chat Operators")).append("</h1>");
    String chat_operators =
        "Aubrey,Casper,COOTMASTER,Emily,Gummo,Hobo,Humanoid,iDan,lexie,OfficerSparker,Scott1x,THX1138,WolfWalker,Wyrdjax,Daemon,Trinity";
    appendListOfNames(chat_operators, sb);
    sb.append("</ul>");
    sb.append("<h1>").append(I18n.tr("FrostWire Forum Moderators")).append("</h1>");
    String forum_moderators =
        "Aaron.Walkhouse,Calliope,cootmaster,Efrain,et voil&agrave;,nonprofessional,Only A Hobo,spuggy,stief,The_Fox";
    sb.append("<ul>");
    appendListOfNames(forum_moderators, sb);
    sb.append("</ul>");
    sb.append("<h1>").append(I18n.tr("Many Former Chat Operators")).append("</h1>");
    String former_operators =
        "AlleyCat,Coelacanth,Gollum,Jewels,Jordan,Kaapeli,Malachi,Maya,Sabladowah,Sweet_Songbird,UB4T,jwb,luna_moon,nonproffessional,sug,the-jack,yummy-brummy";
    sb.append("<ul>");
    ...
    String az_devs =
        "Olivier Chalouhi (gudy),Alon Rohter (nolar),Paul Gardner (parg),ArronM (TuxPaper),Paul Duran (fatal_2),Jonathan Ledlie(ledlie),Allan Crooks (amc1),Xyrio (muxumx),Michael Parker (shadowmatter),Aaron Grunthal (the8472)";
    sb.append("<ul>");
    ...
    sb.append(
        I18n.tr(
            "Several colleagues in the Gnutella community merit special thanks. These include:"));
    sb.append(
        "<ul>\n"
    ...
    sb.append("<p>")
        .append(
            I18n.tr(
                "For helping distribute Frostwire to opensource communities in a very simple manner."))
        .append("</p>");
    sb.append("<ul>");
    ...
    sb.append("<p>")
        .append(
            I18n.tr(
                "For making the world a better place with such an excellent distro, you'll be the ones to make a difference on the desktop."))
        .append("</p>");
    sb.append("<h1>").append(I18n.tr("Thanks to the NSIS Project")).append("</h1>");
    sb.append("<p>")
        .append(I18n.tr("Thanks for such an awesome installer builder system and documentation."))
        .append("</p>");
    ...
    sb.append("<ul>\n");
    sb.append(
        "<li>Angel Leon (<a href='https://github.com/frostwire/frostwire/commits?author=gubatron'>@gubatron</a>)</li>");
    sb.append(
        "<li>Avery King (<a href='https://github.com/frostwire/frostwire/commits?author=generic-pers0n'>@generic-pers0n</a>)</li>");
    sb.append("</ul>");
    // bt notice
    sb.append("<small>");
    sb.append("<br><br>");
    sb.append(
        I18n.tr("BitTorrent, the BitTorrent Logo, and Torrent are trademarks of BitTorrent, Inc."));
    sb.append("</small>");
    sb.append("</body></html>");
