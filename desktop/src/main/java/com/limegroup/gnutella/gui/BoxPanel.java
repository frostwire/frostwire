...
public class BoxPanel extends JPanel {
    /**
     * Constant for specifying that the underlying `BoxLayout` should
    ...
    /**
     * Creates a default `BoxPanel` with a `BoxLayout` oriented
     * along the y axis.
     */
    public BoxPanel() {
    ...
    /**
     * Creates a `BoxPanel` with a `BoxLayout` that uses the
