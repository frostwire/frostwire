...
public class TelluridePlaylistPartialUISearchResult extends AbstractUISearchResult {
    public TelluridePlaylistPartialUISearchResult(TellurideSearchResult sr, SearchEngine se, String query) {
        super(sr, se, query);
    }
