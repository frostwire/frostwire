...
public class TellurideUISearchResult extends AbstractUISearchResult {
  ...
  public TellurideUISearchResult(
      TellurideSearchResult sr, SearchEngine se, String query, boolean extractAudio) {
    super(sr, se, query);
  ...
  public JPopupMenu createMenu(
    ...
    PopupUtils.addMenuItem(
        I18n.tr("Copy Download URL"),
        e -> GUIMediator.setClipboardContent(sr.getDownloadUrl()),
        popupMenu,
        true,
        0);
    PopupUtils.addMenuItem(
    ...
    PopupUtils.addMenuItem(
        SearchMediator.TELLURIDE_DETAILS_STRING + " " + sr.getSource(),
