...
public class SettingsAdapter {
    ...
    switch (category) {
      case "connection":
        settings.addProperty(
            "vpnDropProtection", ConnectionSettings.VPN_DROP_PROTECTION.getValue());
        settings.addProperty(
            "dhtEnabled", SharingSettings.ENABLE_DISTRIBUTED_HASH_TABLE.getValue());
      ...
      case "library":
        ...
        settings.addProperty(
            "torrentsDir", SharingSettings.TORRENTS_DIR_SETTING.getValue().getAbsolutePath());
        break;
      case "sharing":
        settings.addProperty(
            "seedFinishedTorrents", SharingSettings.SEED_FINISHED_TORRENTS.getValue());
        settings.addProperty(
      ...
      case "search":
        ...
        engines.addProperty(
            "soundcloud", SearchEnginesSettings.SOUNDCLOUD_SEARCH_ENABLED.getValue());
        engines.addProperty(
            "archiveOrg", SearchEnginesSettings.INTERNET_ARCHIVE_SEARCH_ENABLED.getValue());
        engines.addProperty(
            "frostclick", SearchEnginesSettings.FROSTCLICK_SEARCH_ENABLED.getValue());
        ...
        engines.addProperty(
            "torrentscsv", SearchEnginesSettings.TORRENTSCSV_SEARCH_ENABLED.getValue());
        ...
        engines.addProperty(
            "torrentdownloads", SearchEnginesSettings.TORRENTDOWNLOADS_SEARCH_ENABLED.getValue());
        settings.add("engines", engines);
        break;
      case "vpn":
        settings.addProperty(
            "dropProtectionEnabled", ConnectionSettings.VPN_DROP_PROTECTION.getValue());
        break;
      case "icebridge":
        settings.addProperty(
            "ICEBRIDGE_ENABLED", SearchEnginesSettings.ICEBRIDGE_ENABLED.getValue());
        settings.addProperty(
            "ICEBRIDGE_USE_REMOTE", SearchEnginesSettings.ICEBRIDGE_USE_REMOTE.getValue());
        settings.addProperty(
            "ICEBRIDGE_REMOTE_URL", SearchEnginesSettings.ICEBRIDGE_REMOTE_URL.getValue());
        settings.addProperty(
            "ICEBRIDGE_REMOTE_AUTH_TOKEN_SET",
            !SearchEnginesSettings.ICEBRIDGE_REMOTE_AUTH_TOKEN.getValue().isEmpty());
        settings.addProperty(
            "ICEBRIDGE_BIND_HOST", SearchEnginesSettings.ICEBRIDGE_BIND_HOST.getValue());
        settings.addProperty("ICEBRIDGE_ROLE", SearchEnginesSettings.ICEBRIDGE_ROLE.getValue());
        settings.addProperty(
  ...
  private static Map<String, Setting> getSettingMap() {
    ...
    map.put(
        "INTERNET_ARCHIVE_SEARCH_ENABLED", SearchEnginesSettings.INTERNET_ARCHIVE_SEARCH_ENABLED);
    ...
    map.put(
        "TORRENTDOWNLOADS_SEARCH_ENABLED", SearchEnginesSettings.TORRENTDOWNLOADS_SEARCH_ENABLED);
    map.put("ICEBRIDGE_ENABLED", SearchEnginesSettings.ICEBRIDGE_ENABLED);
    map.put("ICEBRIDGE_USE_REMOTE", SearchEnginesSettings.ICEBRIDGE_USE_REMOTE);
    map.put("ICEBRIDGE_REMOTE_URL", SearchEnginesSettings.ICEBRIDGE_REMOTE_URL);
