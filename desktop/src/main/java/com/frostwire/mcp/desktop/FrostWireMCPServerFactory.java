...
import com.frostwire.mcp.desktop.tools.DiscoveredPeersTool;
import com.frostwire.mcp.desktop.tools.RelayStatusTool;
...
public final class FrostWireMCPServerFactory {
  ...
  private static final class TransfersResource implements MCPResource {
    ...
    public String description() {
      return "Live list of all transfers";
    }
  ...
  private static final class TransferDetailResource implements MCPResource {
    @Override
    public String uri() {
      return "frostwire://transfers/detail";
    }
    ...
    @Override
    public String description() {
      return "Detailed status of all active transfers";
    }
  ...
  private static final class TransferFilesResource implements MCPResource {
    @Override
    public String uri() {
      return "frostwire://transfers/files";
    }
  ...
  private static final class LibraryResource implements MCPResource {
    ...
    @Override
    public String description() {
      return "FrostWire media library overview";
    }
  ...
  private static final class SettingsResource implements MCPResource {
    ...
    @Override
    public String description() {
      return "Current FrostWire settings snapshot";
    }
  ...
  private static final class BTEngineStatusResource implements MCPResource {
    @Override
    public String uri() {
      return "frostwire://btengine/status";
    }

    @Override
    public String name() {
      return "BTEngine Status";
    }

    @Override
    public String description() {
      return "Current BitTorrent engine status";
    }
  ...
  private static final class VPNStatusResource implements MCPResource {
    ...
    @Override
    public String description() {
      return "Current VPN protection status";
    }
