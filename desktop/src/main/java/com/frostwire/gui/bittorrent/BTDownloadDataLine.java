...
public final class BTDownloadDataLine extends AbstractDataLine<BTDownload> {
    ...
    static {
        ...
        BYTES_UPLOADED_COLUMN = new LimeTableColumn(columns.size(), "DOWNLOAD_BYTES_UPLOADED_COLUMN", I18n.tr("Uploaded"), 20, true, SizeHolder.class);
        ...
        PAYMENT_OPTIONS_COLUMN = new LimeTableColumn(columns.size(), "PAYMENT_OPTIONS_COLUMN", I18n.tr("Tips/Donations"), 126, false, PaymentOptions.class);
