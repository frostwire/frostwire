...
public class TransferDetailFilesTableMediator
    extends AbstractTableMediator<
        TransferDetailFilesModel,
        TransferDetailFilesDataLine,
        TransferDetailFiles.TransferItemHolder> {
  ...
  protected void setupConstants() {
    ...
    DefaultTableCellRenderer skippedRenderer =
  ...
  private void showPriorityPopup(
      Component invoker, int x, int y, TransferDetailFiles.TransferItemHolder holder) {
  ...
  protected JPopupMenu createPopupMenu() {
    ...
    TransferDetailFiles.TransferItemHolder transferItemHolder =
        transferDetailFilesDataLine.getInitializeObject();
    ...
    if (transferItemHolder.skipped) {
      ...
      if (transferItemHolder.complete) {
        ...
        menu.add(new TransferDetailFilesActionsRenderer.ShareAction(transferItemHolder));
      }
    }
  ...
  protected void setDefaultEditors() {
    TransferDetailFilesDataLine.ACTIONS_COLUMN.setCellEditor(
        new GenericCellEditor(getTransferDetailFileActionsRenderer()));
    TransferDetailFilesDataLine.ACTIONS_COLUMN.setCellRenderer(
        getTransferDetailFileActionsRenderer());
  }
