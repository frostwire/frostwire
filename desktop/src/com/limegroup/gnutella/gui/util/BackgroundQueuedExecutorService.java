 ...
 */
public class BackgroundQueuedExecutorService {
    /**
     * Queue for items to be run in the background.
     */
    private static final ExecutorService QUEUE = ExecutorsHelper.newProcessingQueue("BackgroundQueuedExecutor");

    private BackgroundQueuedExecutorService() {
    }
