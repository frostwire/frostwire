    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        checkbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CheckBoxSeedingPreference2.this.setChecked(checkbox.isChecked());
                CheckBoxSeedingPreference2.this.getOnPreferenceChangeListener().onPreferenceChange(CheckBoxSeedingPreference2.this,
                        checkbox.isChecked());
            }
        });
