...
public class UISoundcloudDownload extends SoundcloudDownload {
    ...
    private FWFileDescriptor createFileDescriptor(File file) {
        ...
        fd.fileType = Constants.FILE_TYPE_AUDIO; // Soundcloud files are audio
    ...
    private void buildTorrentAndSeedIt(final FWFileDescriptor fd) {
        try {
            ...
            LOG.info("Successfully created and started seeding torrent for SoundCloud download: " + fd.filePath);
        } catch (Throwable e) {
            LOG.error("Error creating torrent for SoundCloud download seed: " + fd.filePath, e);
        }
    }
