...
final class AndroidSharedTorrentIndexer implements BTEngineListener, AutoCloseable {
  private static final Logger LOG = Logger.getLogger(AndroidSharedTorrentIndexer.class);
