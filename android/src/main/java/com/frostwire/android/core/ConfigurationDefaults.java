...
final class ConfigurationDefaults {
    ...
    private void load() {
        ...
        defaultValues.put(Constants.PREF_KEY_GUI_DISTRACTION_FREE_SEARCH, true);
        ...
        // defaultValues.put(Constants.PREF_KEY_SEARCH_USE_TORRENTDOWNLOADS, true); // Constant not defined
